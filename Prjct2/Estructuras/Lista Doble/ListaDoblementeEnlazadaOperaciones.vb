...
Public Class ListaDoblementeEnlazadaCircularOperaciones
    Private head As NodoLDE

    Public Property myHead As NodoLDE
        Get
            Return head
        End Get
    ...
    Public Sub New(ByVal n As NodoLDE)
        head = n
    End Sub

    Public Sub Insertar(ByVal n As NodoLDE)
    ...
    Public Sub Guardar(ByVal Ruta As String, ByVal Datos As String)
